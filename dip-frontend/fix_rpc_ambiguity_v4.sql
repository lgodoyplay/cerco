-- FIX RPC AMBIGUITY V4 (Error 42702)
-- Renaming parameters to 'p_*' to avoid conflict with table columns.
-- Frontend MUST be updated to send { p_email, p_password, ... }
...
-- 2. RECREATE WITH PREFIXED PARAMETERS
