...
const PRFIntegration = () => {
  const [activeTab, setActiveTab] = useState('seizure'); // seizure, fine, history
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6">
        {activeTab === 'seizure' && <SeizureForm onSuccess={() => setActiveTab('history')} />}
        {activeTab === 'fine' && <FineForm onSuccess={() => setActiveTab('history')} />}
        {activeTab === 'history' && (
