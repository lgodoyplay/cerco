...
const modules = [
  {
    id: 1,
    title: 'Módulo 1 — História e Missão da FEDERAL EUFORIA',
    description: 'A origem, evolução e o papel constitucional da instituição.',
    content: [
      'Origem histórica da FEDERAL EUFORIA no Brasil.',
      ...
      'A FEDERAL EUFORIA como Polícia Judiciária da União.'
    ]
  },
  {
    id: 2,
    title: 'Módulo 2 — Estrutura Organizacional',
    description: 'Como a FEDERAL EUFORIA está organizada em todo o território do Estado da Euforia.',
    content: [
  ...
  {
    id: 3,
    title: 'Módulo 3 — Carreiras da FEDERAL EUFORIA',
    description: 'Os cargos que compõem a força policial e suas funções.',
    content: [
      'Delegado de FEDERAL EUFORIA: presunção de inquéritos e operações.',
      'Agente de Polícia: investigação e execução de operações.',
      'Escrivão de FEDERAL EUFORIA: formalização dos atos de polícia judiciária.',
  ...
  },
  {
    ...
    description: 'A atuação da FEDERAL EUFORIA além das fronteiras.',
    content: [
  ...
  {
    id: 11,
    title: 'Módulo 11 — O Padrão de Excelência FEDERAL EUFORIA',
    description: 'O compromisso com a sociedade brasileira.',
    content: [
      'A credibilidade da FEDERAL EUFORIA perante a sociedade.',
      'A busca constante por inovação e aprimoramento.',
      'O orgulho de pertencer e servir.',
      'Bem-vindo à FEDERAL EUFORIA.'
    ]
  }
];
...
const examQuestions = [
  ...
  {
    id: 14,
    question: 'Em operações interagências (ex: FEDERAL EUFORIA + PRF), o comando deve ser:',
    options: [
...
const CursoDPF = () => {
  ...
  const handleExamSubmit = async () => {
    ...
    try {
      const mensagem = [
        'Prova FEDERAL EUFORIA - Capacitação Técnica Superior (Curso Avançado)',
      ...
      <section className="relative overflow-hidden bg-slate-950">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-20 lg:py-28 flex flex-col items-center text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-federal-900/60 border border-federal-700/70 text-federal-200 text-xs font-semibold uppercase tracking-[0.18em] mb-6">
            ...
            <span>Treinamento Oficial FEDERAL EUFORIA</span>
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white mb-6">
            Curso de Formação Institucional
          </h1>
          <p className="text-lg text-slate-300 max-w-2xl mx-auto">
            Material de estudo para novos integrantes da FEDERAL EUFORIA, focado na estrutura,
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          <div>
            ...
            <p className="text-slate-300 mt-3 max-w-2xl">
              Cada módulo aborda um aspecto fundamental da FEDERAL EUFORIA, desde sua história e estrutura
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div className="space-y-4">
            ...
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              A FEDERAL EUFORIA atua com base em inteligência e prova técnica. A investigação criminal é o instrumento
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="bg-federal-900/70 border border-federal-700/60 rounded-2xl p-5 sm:col-span-2">
              ...
              <p className="text-xs sm:text-sm text-federal-50">
                A união entre investigação, inteligência e perícia permite à FEDERAL EUFORIA enfrentar a criminalidade
          ...
          <div className="bg-slate-950 border border-slate-800 rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="flex items-center justify-between px-6 sm:px-8 py-4 border-b border-slate-800">
              <div>
                ...
                <p className="text-sm font-semibold text-white">
                  Curso de Aperfeiçoamento Profissional – FEDERAL EUFORIA
                </p>
              </div>
              <button
                type="button"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-900 border border-slate-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-federal-500"
                        placeholder="Ex: FEDERAL EUFORIA, Superintendência Regional"
                      />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-slate-400 uppercase tracking-wider">
