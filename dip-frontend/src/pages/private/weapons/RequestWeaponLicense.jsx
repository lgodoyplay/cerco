...
const RequestWeaponLicense = () => {
  ...
  const steps = [
    ...
    "Aguardar a análise inicial da CIVIL EUFORIA (acompanhe pelo Discord/Email).",
      ...
      {step === 3 && (
        <div className="max-w-md mx-auto bg-slate-900/50 border border-slate-800 rounded-2xl p-8 text-center animate-in zoom-in duration-300">
          ...
          <p className="text-slate-400 mb-8">
            Sua solicitação foi registrada com sucesso. A CIVIL EUFORIA analisará seus dados e entrará em contato em breve.
          </p>
          <button
            onClick={() => {
              setStep(1);
