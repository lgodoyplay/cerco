    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-md p-6">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-white tracking-tight mb-2">CIVIL EUFORIA</h1>
          <div className="h-1 w-20 bg-federal-600 mx-auto mb-4 rounded-full" />
          <p className="text-slate-500 text-xs mt-2 uppercase tracking-widest">CIVIL EUFORIA - Acesso Restrito</p>
        </div>
