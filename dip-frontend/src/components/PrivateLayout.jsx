      ...
      >
        ...
        <div className="h-20 flex items-center px-6 border-b border-slate-800 bg-slate-900/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-federal-600 flex items-center justify-center shadow-lg shadow-federal-600/20">
              <Shield className="text-white" size={24} />
            </div>
            <div>
              <h1 className="font-bold text-lg tracking-tight text-white leading-none">DICOR</h1>
              <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mt-1">Polícia Federal</p>
            </div>
          </div>
          <button 
