  ...
  const navCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/dashboard/investigations/informantes', icon: UserPlus, label: 'Informantes', prefetchKey: 'InformantesList', permission: 'informantes_view' },
      ...
      >
        <div className="p-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/LOGO.gif" alt="Logo FEDERAL EUFORIA" className="w-8 h-8 rounded-lg shadow-lg shadow-federal-900/50 object-cover" />
            <span className="font-bold text-lg tracking-tight">FEDERAL EUFORIA - Polícia Federal</span>
          </div>
